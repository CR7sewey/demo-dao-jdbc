...
public class Program {
	...
	public static void main(String[] args) {
		...
		SellerDao selleDao = DaoFactory.createSellerDao(); // assim programa nao conece a implementacao, so a interface!, injecao de dependencia sem explicitar implementacao 
